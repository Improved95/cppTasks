...
void ShowInfo::coutInstruction() {
    const string message =  "Describe in config.txt used converters and their parameters. Converters are applied sequentially.\n"
                      ...
                      "delay <t1> <t2> <Dry/Wet(int (0-100))> <FeedBack(int)> <Temp(int)> <Time Of delay(int)>\t - Creates an echo effect of the original sound from t1 to t2. Parameters: Degree of mixing;\n"
